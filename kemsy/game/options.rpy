...
define config.name = _("Бесконечность в КемГУ")
...
define gui.about = _p("""
Автор - Пронина Анастасия,Хисамутдинов Игорь и Костиков Артем
Музыку писали: Ангелина
""")
...
define config.save_directory = "kemsy-1732517699"
